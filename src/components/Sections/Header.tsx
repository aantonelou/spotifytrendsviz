...
const Header: FC = memo(() => {
  ...
  const navSections = useMemo(
    () => [SectionId.Home, SectionId.Dashboard, SectionId.Presentation, SectionId.About],
    [],
  );
...
const DesktopNav: FC<{navSections: SectionId[]; currentSection: SectionId | null}> = memo(
  ({navSections, currentSection}) => {
    ...
    const activeClass = classNames(baseClass, 'text-emerald-800');
    const inactiveClass = classNames(baseClass, 'text-neutral-100');
    return (
      <header className="fixed top-0 z-50 hidden w-full bg-neutral-400/50 p-4 backdrop-blur sm:block" id={headerID}>
...
const MobileNav: FC<{navSections: SectionId[]; currentSection: SectionId | null}> = memo(
  ({navSections, currentSection}) => {
    ...
    const activeClass = classNames(baseClass, 'bg-neutral-400 text-white font-bold');
