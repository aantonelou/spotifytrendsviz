    ...
    <Section noPadding sectionId={SectionId.Dashboard} className="p-12" style={{ background: "rgba(109,139,133,255)" }}>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center mt-8">
        <div className="w-full md:w-1/2 p-2">
          <div style={{ padding: '1rem', borderRadius: '8px', margin: '2rem 0', color: 'white' }}>
            <p>This dashboard shows the appearance of various artists in top hit charts over time and it's fascinating to see how the popularity of artists has evolved, noticing the spikes during major album releases or significant events in their careers. 
